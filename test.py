...
class Test(unittest.TestCase):
    ...
    def testNoMilitaryFormat(self): #malicia
        myParking = parking(10)
        self.assertTrue(myParking.addReservation("6","10"))
        self.assertTrue(myParking.addReservation("7","10"))
        self.assertTrue(myParking.addReservation("8","10"))
        self.assertTrue(myParking.addReservation("9","10"))
        self.assertTrue(myParking.addReservation("7","11"))
        self.assertTrue(myParking.addReservation("8","12"))
        self.assertTrue(myParking.addReservation("9","13"))
        self.assertTrue(myParking.addReservation("6","09"))
        self.assertTrue(myParking.addReservation("6","10"))
        self.assertTrue(myParking.addReservation("6","10"))
        self.assertTrue(myParking.addReservation("6","10"))
        self.assertFalse(myParking.addReservation("9","10"))
        self.assertTrue(myParking.addReservation("10","15"))
        self.assertTrue(myParking.addReservation("10","15"))
        self.assertTrue(myParking.addReservation("10","15"))
        self.assertTrue(myParking.addReservation("10","15"))
        self.assertTrue(myParking.addReservation("10","15"))
